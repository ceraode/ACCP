...
namespace Day05体检套餐
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            liverFun = new HealthItem("肝功能","用于检测肝",50);
            ekg = new HealthItem("心电图","用于检测心脏",50);
            bWaves = new HealthItem("B超","用于检测B超",100);
            bloodPressure = new HealthItem("血压","用于检测血压",30);
            bloodTest = new HealthItem("血常规","用于检测血常规",50);
            ...
            healthItems.Add(liverFun.HealthItemName,liverFun);
            healthItems.Add(ekg.HealthItemName,ekg);
            healthItems.Add(bWaves.HealthItemName,bWaves);
            healthItems.Add(bloodPressure.HealthItemName,bloodPressure);
            healthItems.Add(bloodTest.HealthItemName,bloodTest);
